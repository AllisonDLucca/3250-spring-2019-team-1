...
class TestClassFile(unittest.TestCase):
    ...
    def test_parse_class_file(self):
        ...
        self.assertEqual(self.cf.method_table.__len__(), 1)
        self.assertEqual(type(self.cf.method_table[0]), type(MethodInfo()))

        self.assertEqual(self.cf.attribute_table.__len__(), 1)
        self.assertEqual(type(self.cf.attribute_table[0]), type(CodeAttribute()))
