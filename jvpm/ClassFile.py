...
class ClassFile:
    ...
    def _parse_class_file(self):
        ...
        self._get_minor()
        self._get_major()
        self._get_constant_pool_count()
        self._create_c_pool()
        self._get_interface_count()
        self._get_field_count()
        self._get_method_count()
        self._create_method_table()
        self._get_attribute_count()
    ...
    def _create_c_pool(self):
        ...
        maximum = int(self._get_constant_pool_count()) - 1
    ...
    def _get_field_count(self):
        return (
            self.data[18 + self._get_constant_pool_size() + self._get_interface_count()]
    ...
    def _create_attribute_table(self):
        ...
        for i in range(0, self._get_attribute_count()):
            ...
            count = count + 13
            for i in range(0, code_att.code_length):
            ...
            while code_index < len(self.attribute_table[table_index].code):
                ...
                if value in (54, 21, 23):
                    ...
                    ops.interpret(
                        value,
                        [
                            self.attribute_table[table_index].code[code_index - 1],
                            self.attribute_table[table_index].code[code_index],
                        ],
                        self.c_pool_table,
                    )
